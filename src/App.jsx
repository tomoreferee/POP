          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            {hasLiveSession && (
              <button
                ...
                style={{ background: "#0a1a2a", border: "1px solid #4e9af166", color: "#4e9af1", borderRadius: 7, padding: "4px 10px", cursor: "pointer", fontFamily: "inherit", fontSize: 11, fontWeight: 700, letterSpacing: 1 }}
